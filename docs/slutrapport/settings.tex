...
\usepackage[
    ...
    style=numeric,
    sorting=none
]{biblatex} %our modified package with references ordered by appearance in document.
%\usepackage[backend=biber,hyperref]{biblatex} %old standard package
...
%standard chapter layout, used for everything except appendix
...
\makebox[0.8cm]{\chapnumfont\strut \thechapter}}
\fi
& \chaptitlefont ##1
\end{tabular}
\NoChapNumberfalse
...
%start of special chapter layout, used for appendix
\makechapterstyle{Bilagor}{
\renewcommand{\figurename}{Figur}
\renewcommand{\tablename}{Tabell}
\renewcommand\chapternamenum{}
\renewcommand\printchaptername{}
...
\ifNoChapNumber\relax\else%
\colorbox{black}{\color{white}%
\makebox[3.2cm]{\chapnumfont\strut \thechapter}}
\fi
& \chaptitlefont ##1
\end{tabular}
\NoChapNumberfalse
